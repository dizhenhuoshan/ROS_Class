...
(cl:defmethod cl:initialize-instance :after ((m <Add-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Add-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name beginner_tutorials-srv:<Add-request> is deprecated: use beginner_tutorials-srv:Add-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Add-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Add-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name beginner_tutorials-srv:<Add-response> is deprecated: use beginner_tutorials-srv:Add-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Add-response>)))
  ...
  "beginner_tutorials/AddResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Add-response)))
  "Returns string type for a service object of type 'Add-response"
  "beginner_tutorials/AddResponse")
