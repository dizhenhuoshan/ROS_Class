...
(cl:defmethod cl:initialize-instance :after ((m <nstr>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'nstr)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name beginner_tutorials-msg:<nstr> is deprecated: use beginner_tutorials-msg:nstr instead.")))
