...
(cl:defmethod cl:initialize-instance :after ((m <SetSpeed-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetSpeed-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name chapter4-srv:<SetSpeed-request> is deprecated: use chapter4-srv:SetSpeed-request instead.")))

(cl:ensure-generic-function 'desired_speed-val :lambda-list '(m))
(cl:defmethod desired_speed-val ((m <SetSpeed-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader chapter4-srv:desired_speed-val is deprecated.  Use chapter4-srv:desired_speed instead.")
  (desired_speed m))
...
(cl:defmethod cl:initialize-instance :after ((m <SetSpeed-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetSpeed-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name chapter4-srv:<SetSpeed-response> is deprecated: use chapter4-srv:SetSpeed-response instead.")))

(cl:ensure-generic-function 'previous_speed-val :lambda-list '(m))
(cl:defmethod previous_speed-val ((m <SetSpeed-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader chapter4-srv:previous_speed-val is deprecated.  Use chapter4-srv:previous_speed instead.")
  (previous_speed m))

(cl:ensure-generic-function 'new_speed-val :lambda-list '(m))
(cl:defmethod new_speed-val ((m <SetSpeed-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader chapter4-srv:new_speed-val is deprecated.  Use chapter4-srv:new_speed instead.")
  (new_speed m))

(cl:ensure-generic-function 'stalled-val :lambda-list '(m))
(cl:defmethod stalled-val ((m <SetSpeed-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader chapter4-srv:stalled-val is deprecated.  Use chapter4-srv:stalled instead.")
  (stalled m))
